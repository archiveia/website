			...
			return [
				createElement(MediaUpload, {
					...
					render: function(open) {
						return createElement(btn, { onClick: open.open }, attributes.url ? 'PDF: ' + attributes.url : 'Click here to Open Media Library to select PDF');
					},
				}),
				...
				createElement(
					...
					createElement(
						'div',
						{ className: 'pdf_div_main' },
						createElement('hr', {}),
						createElement('p', {}, __('Change the Height & Width of the PDF')),
						createElement('hr', {}),
						createElement('p', {}, __('Enter max or an integer number of pixels.')),
